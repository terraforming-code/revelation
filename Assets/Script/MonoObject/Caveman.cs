...
public class Caveman : MonoBehaviour
{
    ...
    public Sprite citizenHeadDecoSprite;
    SpriteRenderer citizenBriefTabHead, citizenBriefTabFace, citizenBriefTabHeadDeco;
    ...
    void Start()
    {
        ...
        citizenBriefTabHeadDeco = citizenBriefTab.transform.GetChild(0).GetChild(2).GetComponent<SpriteRenderer>();
        ...
        this.transform.Find("bone_006").Find("bone_007").Find("HeadDeco").GetComponent<SpriteRenderer>().sprite = citizenHeadDecoSprite;
    }
    ...
    void Update()
    {
        ...
        if((dir == -1 && -32f > this.transform.localPosition.x) || (dir == 1 && 13f < this.transform.localPosition.x))
        {
    ...
    void OnMouseEnter()
    {
        ...
        citizenBriefTabHeadDeco.sprite = this.transform.GetChild(2).GetChild(0).GetChild(2).GetComponent<SpriteRenderer>().sprite;
